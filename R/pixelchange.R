...
#' @param output whether you want up output the new image
#' @param outpathway the pathway for output image default save to "wd/figures/output.jpg"
#'
...
#'
#' @export
pixelchange <- function (ori_bitmap=image_bitmap, colorscale="grey", output="FALSE",outpathway="figures/output.jpg") {
  ...
  if (output=="TRUE"){image_write(image_read(new_image), path = outpathway, format = "jpg", quality = 95)
